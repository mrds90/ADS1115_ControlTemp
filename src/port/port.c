...
static void PORT_i2cInit(uint8_t clockFrec)

static PORT_i2cWrite(uint8_t i2cSlaveAddress, uint8_t i2c_register, uint16_t data);

static PORT_i2cWriteRead(uint8_t i2cSlaveAddress, uint8_t i2c_register, uint16_t *readden_data);
